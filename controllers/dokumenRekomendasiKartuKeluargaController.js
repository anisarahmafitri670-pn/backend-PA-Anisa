...
const DokumenModel = require('../models/dokumenRekomendasiKartuKeluargaModel');
const { toPosixRelative, safeUnlinkRelativeUpload } = require('../utils/uploadFiles');

const JENIS_DOKUMEN_KARTU_KELUARGA = new Set([
  'surat_keterangan_rt',
...
class DokumenRekomendasiKartuKeluargaController {
  static async uploadDokumen(req, res) {
    try {
      if ((process.env.NODE_ENV || '').toLowerCase() === 'development') {
        console.log('REQ FILES KARTU KELUARGA:', req.files);
      }
...
module.exports = { DokumenRekomendasiKartuKeluargaController, JENIS_DOKUMEN_KARTU_KELUARGA };

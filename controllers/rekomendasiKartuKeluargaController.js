...
class RekomendasiKartuKeluargaController {
  ...
  static async getAllPengajuan(req, res) {
    try {
      const result = await RekomendasiKartuKeluargaModel.getAllPengajuan();
      if (result.success) {
  ...
  static async getPengajuanById(req, res) {
    try {
      ...
      const result = await RekomendasiKartuKeluargaModel.getPengajuanById(id);
  ...
  static async updatePengajuan(req, res) {
    try {
      ...
      const result = await RekomendasiKartuKeluargaModel.updatePengajuan(id, pengajuanData);
  ...
  static async hapusPengajuan(req, res) {
    try {
      ...
      const result = await RekomendasiKartuKeluargaModel.deletePengajuan(id);
